...
class TraineeRecyclerItemTouchHelper(dragDirs: Int, swipeDirs: Int, private val listener: TraineeRecyclerItemTouchHelper.RecyclerItemTouchHelperListener) : ItemTouchHelper.SimpleCallback(dragDirs, swipeDirs) {
    ...
    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
        if (viewHolder != null) {
            val foregroundView = (viewHolder as TraineeListAdapter.ListHolder).viewForeground
