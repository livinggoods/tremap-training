...
public class TrainingExamListAdapter extends RecyclerView.Adapter<TrainingExamListAdapter.ListHolder>{
    private Context mContext;
    private List<TrainingExam> trainingExams;
    private TrainingExamListAdapterListener listener;
    ...
    public TrainingExamListAdapter(Context mContext, List<TrainingExam> exams, TrainingExamListAdapterListener listener){
        this.mContext = mContext;
        this.trainingExams = exams;
    ...
    public void onBindViewHolder(final ListHolder holder, final int position){
        ...
        holder.from.setText(exam.getTitle());
        holder.subject.setText(exam.getCountry());
        holder.message.setText(String.format("Passmark ", exam.getPassmark()));
        holder.timestamp.setText(exam.getDateCreated());

        // displaying the first letter of From in icon text
        holder.iconText.setText(exam.getTitle().substring(0,1));
    ...
    private void applyIconColor(ListHolder holder, TrainingExam exam) {
        holder.imgProfile.setImageResource(R.drawable.bg_circle);
        holder.imgProfile.setColorFilter(exam.getColor());
    ...
    private void applyImportant(ListHolder holder, TrainingExam exam) {
        if (exam.getCountry().equalsIgnoreCase("KE")) {
    ...
    public void removeData(int position) {
        trainingExams.remove(position);
        notifyItemRemoved(position);
        resetCurrentIndex();
    }
    public void restoreItem(TrainingExam exam, int position) {
        trainingExams.add(position, exam);
    ...
    public interface TrainingExamListAdapterListener {
