...
class TrainingSessionRecyclerItemTouchHelper(dragDirs: Int, swipeDirs: Int, private val listener: TrainingSessionRecyclerItemTouchHelper.RecyclerItemTouchHelperListener) : ItemTouchHelper.SimpleCallback(dragDirs, swipeDirs) {
    ...
    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
        if (viewHolder != null) {
            val foregroundView = (viewHolder as TrainingSessionListAdapter.ListHolder).viewForeground
